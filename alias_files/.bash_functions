...
addpath() {
    ...
    # Path to config file
    config_file="$HOME/.alias/.bash_exports"
...
pyinit() {
    ...
    # Get the virtual environment name from the third argument, or default to .venv
    local venv_name=${3:-.venv}
    ...
    if ! python3 -m venv myvenv; then
        ...
        return 1 # Create virtual environment called myvenv
    fi
